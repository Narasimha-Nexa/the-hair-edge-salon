...
import { IconStar, IconUsers, IconCalendar, IconPin } from "@/components/ui/Icon";
...
export default function Hero() {
  ...
  const trustBadges = [
    { Icon: IconStar, value: rating, label: "Google Rating" },
    { Icon: IconUsers, value: reviewCount, label: "Google Reviews" },
    { Icon: IconCalendar, value: "7 Days", label: "Open Weekly" },
    { Icon: IconPin, value: "Madhapur", label: "Hyderabad" },
  ];
        ...
        <div className="text-center animate-fade-in-up">
          ...
          <div className="hero-ctas flex flex-wrap items-center justify-center gap-4 md:gap-6 mb-12" role="group" aria-label="Primary actions">
            <button
              ...
              className="group inline-flex items-center justify-center gap-3 bg-salon-gold text-salon-primary px-8 py-4 rounded-lg font-medium tracking-wider hover:bg-salon-gold-light transition-[background-color,box-shadow] duration-300 hover:shadow-[0_0_40px_rgba(201,162,39,0.3)] focus-visible:ring-2 focus-visible:ring-salon-gold focus-visible:ring-offset-2 focus-visible:ring-offset-salon-primary"
            >
            ...
            <a
              href="#services"               className="inline-flex items-center justify-center gap-2 border-2 border-salon-gold text-salon-gold px-8 py-4 rounded-lg font-medium tracking-wider hover:bg-salon-gold hover:text-salon-primary transition-colors focus-visible:ring-2 focus-visible:ring-salon-gold focus-visible:ring-offset-2 focus-visible:ring-offset-salon-primary"
            >
              View Services
            </a>
            <a
          ...
          <div className="hero-badges grid grid-cols-2 gap-x-6 gap-y-5 text-center sm:flex sm:flex-wrap sm:justify-center sm:gap-6 md:gap-10" role="list" aria-label="Trust signals">
            {trustBadges.map((badge, index) => {
              const BadgeIcon = badge.Icon;
              return (
                <div key={index} className="flex flex-col items-center gap-1 animate-fade-in-up delay-200" role="listitem">
                  <div className="flex items-center gap-1.5 text-salon-gold" aria-hidden="true">
                    <BadgeIcon className="w-5 h-5 md:w-6 md:h-6" />
                    <span className="font-heading font-bold text-xl md:text-2xl text-salon-white">
                      {badge.value}
                    </span>
                  </div>
