...
export const metadata: Metadata = {
  title: `Page Not Found | ${salonConfig.business.name}`,
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="text-center max-w-md mx-auto animate-fade-in-up">
          <div className="w-24 h-24 mx-auto mb-8 bg-salon-gold/10 rounded-full flex items-center justify-center">
            <svg className="w-12 h-12 text-salon-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h1 className="font-heading text-6xl text-salon-white mb-2">404</h1>
          <h2 className="font-heading text-2xl text-salon-white mb-4">Page Not Found</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href={generateWhatsAppUrl(`Hello ${salonConfig.business.name}, I couldn't find what I was looking for on your website.`)}
              target="_blank"
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <p className="text-salon-muted text-sm mb-4">Or explore our main sections:</p>
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm">
              <Link href="#services" className="text-salon-muted hover:text-salon-gold transition-colors">Services</Link>
              <span className="text-salon-muted/30">·</span>
              <Link href="#menu" className="text-salon-muted hover:text-salon-gold transition-colors">Menu</Link>
              <span className="text-salon-muted/30">·</span>
              <Link href="#contact" className="text-salon-muted hover:text-salon-gold transition-colors">Contact</Link>
              <span className="text-salon-muted/30">·</span>
              <a href={generateCallUrl()} className="text-salon-muted hover:text-salon-gold transition-colors">Call Us</a>
            </div>
          </div>
        </div>
      </div>
