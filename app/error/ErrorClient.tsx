    ...
    <main className="min-h-screen bg-salon-primary flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="text-center max-w-md mx-auto animate-fade-in-up">
          ...
          <h1 className="font-heading text-4xl text-salon-white mb-4">Something Went Wrong</h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href={generateWhatsAppUrl(`Hello ${salonConfig.business.name}, I encountered an error on your website.`)}
              target="_blank"
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <p className="text-salon-muted text-sm mb-4">Or contact us directly:</p>
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm">
              <a href={generateCallUrl()} className="text-salon-muted hover:text-salon-gold transition-colors">Call: +91 89853 10570</a>
              <span className="text-salon-muted/30">·</span>
              <a href={generateWhatsAppUrl(`Hello ${salonConfig.business.name}, I need assistance.`)} target="_blank" rel="noopener noreferrer" className="text-salon-muted hover:text-salon-gold transition-colors">WhatsApp</a>
            </div>
          </div>
        </div>
      </div>
